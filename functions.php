<?php
/**
 * Showcase Theme functions and definitions.
 *
...
function showcase_scripts() {
	...
	wp_enqueue_style( 'google-web-fonts', 'https://fonts.googleapis.com/icon?family=Material+Icons');
	wp_enqueue_style( 'red-starter-style', get_stylesheet_uri() );
	wp_enqueue_script( 'red-starter-skip-link-focus-fix', get_template_directory_uri() . '/build/js/skip-link-focus-fix.min.js', array(), '20130115', true );
	wp_enqueue_script( 'script', get_template_directory_uri() . '/build/js/main.js', array ( 'jquery' ), 1.1, true);
	wp_enqueue_script( 'instagram', get_template_directory_uri() . '/build/js/instagram.js', array ( 'jquery' ), 1.1, true);
