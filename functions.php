...
function showcase_scripts() {
	...
	wp_enqueue_script( 'script', get_template_directory_uri() . '/build/js/main.min.js', array ( 'jquery' ), 1.1, true);
	wp_enqueue_script( 'instagram', get_template_directory_uri() . '/build/js/instagram.min.js', array ( 'jquery' ), 1.1, true);
